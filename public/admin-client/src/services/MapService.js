// /admin-client/src/services/MapService.js
...
class MapService {
    ...
    static async calculateDistance(coord1, coord2, useGoogleMaps = true) {
        // Exemplo de cálculo de distância com Google ou Mapbox
        // A distância pode ser calculada usando Haversine formula ou APIs de rota (Google Directions/Mapbox Directions)
        const apiKey = useGoogleMaps ? process.env.GOOGLE_MAPS_API_KEY : process.env.MAPBOX_API_KEY;
        const apiUrl = useGoogleMaps
